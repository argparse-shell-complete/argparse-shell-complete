...
class GeneralAbbreviationGenerator():
    ...
    def get_many_abbreviations(self, words):
        ...
        '''
        assert is_iterable(words), "GeneralAbbreviationGenerator.get_many_abbreviations: words: excpected iterable, got %r" % words
...
class OptionAbbreviationGenerator(GeneralAbbreviationGenerator):
    ...
    def __init__(self, words):
        assert is_iterable(words), "OptionAbbreviationGenerator.get_many_abbreviations: words: excpected iterable, got %r" % words
...
class DummyAbbreviationGenerator():
    ...
    def get_many_abbreviations(self, words):
        assert is_iterable(words), "DummyAbbreviationGenerator.get_many_abbreviations: words: excpected iterable, got %r" % words
